...
use App\Http\Controllers\NapboxController;
...
Route::middleware('admin')->group(function () {
    ...
    Route::post('/admin/mikrotik/{mikrotik}/assign-napboxes', [MikrotikController::class, 'assignNapboxes'])->name('admin.mikrotik.assign-napboxes');
    Route::get('/admin/napboxes', [NapboxController::class, 'index'])->name('admin.napboxes');
    Route::get('/admin/napboxes/create', [NapboxController::class, 'create'])->name('admin.napboxes.create');
    Route::post('/admin/napboxes', [NapboxController::class, 'store'])->name('admin.napboxes.store');
    Route::get('/admin/napboxes/{napbox}/edit', [NapboxController::class, 'edit'])->name('admin.napboxes.edit');
    Route::post('/admin/napboxes/{napbox}/update', [NapboxController::class, 'update'])->name('admin.napboxes.update');
    Route::post('/admin/napboxes/{napbox}/delete', [NapboxController::class, 'destroy'])->name('admin.napboxes.delete');
